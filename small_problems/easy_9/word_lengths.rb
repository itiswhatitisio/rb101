...
# - return a string a space and a string length ("cow 3")
# - words in the string are separated exactly by one space
# - any substring of non-space characters is a word ("ain't 5")
# _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _
...
def word_lengths(str)
  str.split(' ').map { |word| word << ' ' << (word.length - 1).to_s }
end
